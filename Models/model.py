...
class Model:
    ...
    def load_model_objects(self) -> User: # Keep as backup
        exams = [
            Exam(0, ExamTypes.WRITTEN_EXAM, 1, True),  # Artificial Intelligence
            Exam(0, ExamTypes.ADVANCED_WORKBOOK, 1, True),
            # Einführung in das wissenschaftliche Arbeiten für IT und Technik
            Exam(0, ExamTypes.WRITTEN_EXAM, 1, True),  # Einführung in die Programmierung mit Python
            Exam(0, ExamTypes.WRITTEN_EXAM, 1, True),  # Mathematics: Analysis
            Exam(0, ExamTypes.TECHNICAL_PRESENTATION, 1, True),  # Kollaboratives Arbeiten
        ...
        user = User({}, "Clam", degree_program1)
