...
class App:
    def __init__(self):
        ...
        self.treeview.insert("root_node", "end", text="Semester 3", values=("Test", "2"))
        self.treeview.insert("root_node", "end", text="Semester 4", values=("Test", "2"))
        self.treeview.insert("root_node", "end", text="Semester 5", values=("Test", "2"))
        self.treeview.insert("root_node", "end", text="Semester 6", values=("Test", "2"))
